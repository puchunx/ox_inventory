...
const UsefulControls: React.FC<Props> = ({ infoVisible, setInfoVisible }) => {
  ...
  return (
    <>
      {isMounted && (
        <FloatingPortal>
          <FloatingOverlay lockScroll className="info-dialog-overlay" data-open={infoVisible} style={styles}>
            <FloatingFocusManager context={context}>
              <div ref={refs.setFloating} {...getFloatingProps()} className="info-dialog" style={styles}>
                <div className="info-dialog-title">
                  <p>{Locale.ui_usefulcontrols || 'Useful controls'}</p>
                  <div className="info-dialog-close" onClick={() => setInfoVisible(false)}>
